...
- [ ] 1.1 TypeScript を 6 系に揃え、型チェックを実行できるようにする
...
- [ ] 1.3 Prettier で書式を揃え、ESLint と衝突させない
...
- [ ] 2.1 一括チェックを用意し、既存コードがすべて通ることを確かめる
