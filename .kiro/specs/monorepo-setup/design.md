...
│       └── vite.config.ts                # [新規]
├── docs/
│   └── guide-cc-sdd.md                   # cc-sdd による開発手順
├── node_modules/                         # [生成]
├── .gitignore
├── CLAUDE.md
├── README.md
...
### Modified Files
- `.kiro/steering/guide-tech.md` — Common Commands に `pnpm build` / `pnpm test` / `pnpm --filter <name> run <script>` を追記する
